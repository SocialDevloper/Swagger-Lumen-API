...
return [
    ...
    'security' => [
        ...
        */
        ...
        'passport' => [ // Unique name of security
            ...
            'flows' => [
                "password" => [
                    "authorizationUrl" => env('PASSPORT_LOGIN_ENDPOINT'),
                    "tokenUrl" => env('PASSPORT_LOGIN_ENDPOINT'),
                    "refreshUrl" => env('PASSPORT_LOGIN_ENDPOINT') . '/refresh',
                    "scopes" => []
                ],
            ],
        ],
    ...
    */
     ...
     */
    'constants' => [
        'SWAGGER_LUME_CONST_HOST' => env('SWAGGER_LUME_CONST_HOST', 'http://localhost.lumenapi.com'),
    ],
];
